<?php
    ...
    define('LANG_CONTENT_SAVE_DRAFT',		 'Зберегти в чернетках');
    ...
    define('LANG_PARSER_NUMBER_DECIMAL_INT', 'Кількість розрядів цілої частини');
    define('LANG_PARSER_NUMBER_DECIMAL_S',   'Кількість розрядів після коми');
    ...
    define('LANG_USERS_SUBSCRIBE',           'Підписатися');
    define('LANG_USERS_UNSUBSCRIBE',         'Відписатися');
    ...
    define('LANG_REQUEST_PARAMS_ERROR',		 'Помилка в параметрах: %s');
    ...
    define('LANG_SEND_AGAIN',				 'Надіслати ще раз');
    define('LANG_SEND_AGAIN_VIA',			 'Надіслати ще раз через ');
    ...
    define('LANG_USERS_SPELL',               'користувач|користувача|користувачів');
