...
define('LANG_AUTH_SEND_INVITES', 'Видати запрошення');
define('LANG_AUTH_REVOKE_INVITES', 'Відкликати всі запрошення');
define('LANG_AUTH_INVITE_NOTIFY', 'За вашим запрошенням зареєструвався <a href="%s">%s</a>');
define('LANG_AUTH_INVITE_SEND_COUNT', 'Вам видано %s');
define('LANG_AUTH_INVITE_SENDED', 'Запрошення відправлені');
define('LANG_AUTH_INVITE_REVOKED', 'Запрошення відкликані');
...
define('LANG_REG_WRONG_INVITE_CODE', 'Код запрошення вказаний неправильно або він вже був використаний');
...
define('LANG_AUTH_INVITES_STARGET', 'Кому видати запрошення');
